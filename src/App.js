...
function App() {
  ...
  const agregar = async(e) => {
    ...
    if(tarea.trim() === ''){
      console.log('datos vacios...'); return;
    }
  ...
  const editar = async(e) => {
    ...
    if(tarea.trim() === ''){
       console.log('datos vacions..'); return;
    }
        ...
        <div className="row">
          <div className="col-md-6">
            {tareas.map((item) => (
              ...
              <button 
              className="btn btn-danger  ml-2 btn-sm float-right"
          ...
          <div className="col-md-6">
            <h3>{modoEdicion ? 'Editar Terea' : 'Agregar Tarea'}</h3>
            <form
